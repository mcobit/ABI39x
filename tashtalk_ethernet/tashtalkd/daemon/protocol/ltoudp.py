...
class LtoudpDaemon:
  ...
  def service_tashtalk(self):
    ...
    rtmp_frame = b'\xff\x01\x01\x00\x0f\x01\x01\x01\xfe\xfe\x08\x01\x00\x00\x02\xfe\xfe\x00\x00\x00'
    print(rtmp_frame)
    self.sender.send_frame(rtmp_frame)
  ...
  def run(self):
    ...
    while True:
      rlist, wlist, xlist = select.select((self.receiver, self.socket), (), (), 0.1)
